...
<div class="form-row">
    <div class="form-group col-md-5">
        ...
        <select class="form-control" name="idtrabajador" id="idtrabajador" autofocus>
    ...
    <div class="form-group col-md-5">
        <strong>{!! Form::label('detalle', 'Detalle del Pedido') !!}</strong>
        {!! Form::text('detalle', null, ['class' => 'form-control', 'onKeyUp' => 'this.value=this.value.toUpperCase();']) !!}
    </div>
...
<form action="{{ url('store-input-fields') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <a href="{{route('regpedidomaterials.index')}}"  class="btn btn-sm btn-primary">Volver</a>
    </div>
